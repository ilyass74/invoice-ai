...
from invoice_parsing import extract_items


def main():
    parser = argparse.ArgumentParser(description="Extract items from OCR output.")
    ...
    try:
        ...
        if ocr_path.is_file():
            from english_layout import fields as english_fields, items as english_extract
        ...
        output = path.with_name(path.name.removesuffix("_text.txt") + "_items.json")
